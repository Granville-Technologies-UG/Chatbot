...
class PDF(FPDF):
    def __init__(self):
        ...
        self.add_font('Montserrat-Bold', '', '../fonts/montserrat/fonts/ttf/Montserrat-Bold.ttf', uni=True)
        self.add_font('Montserrat-Regular', '', '../fonts/montserrat/fonts/ttf/Montserrat-Regular.ttf', uni=True)
        self.add_font('Montserrat-Italic', '', '../fonts/montserrat/fonts/ttf/Montserrat-Italic.ttf', uni=True)
    ...
    def invoice_body(self, user_info, booking_info):
        ...
        self.multi_cell(95, 5, 'Ntinda Complex, Ntinda, Kampala\nInnovation Village, Block D, Ground Floor', 0, 'L')
        self.ln(10) 
        ...
        self.ln(5) 
        self.set_font('Montserrat-Italic', '', 10)
        self.multi_cell(0, 10, "Terms and Conditions:\n1. Payment is due within 30 days.\n2. Please contact us for any inquiries or issues with your booking.", 0, 'L')
